...
const evidence = [
  { id: "BYD-E-001", title: "BYD Annual Report 2021", source: "BYD Company Limited / HKEX disclosure, 2022", sourceUrl: "https://www1.hkexnews.hk/listedco/listconews/sehk/2022/0329/2022032901882.pdf", type: "直接資料", collectionState: "正式URL確認済み", publishedDate: "2022-03-29", coveragePeriod: "2021", authenticity: "高", interpretiveReliability: "中", evidenceWeight: { sourceProximity: "primary", temporalFit: "near_direct", independence: "issuer_disclosure", decisionMakerAccess: "clear", weight: "high", rationale: "BYD自身の年次報告・取引所開示であり、2021年時点の事業構造と戦略説明に近い資料として使えるため。" } },
  { id: "BYD-E-002", title: "BYD Announces all its Pure EVs Will now Come With Blade Batteries", source: "BYD official news, Apr. 7, 2021", sourceUrl: "https://www.byd.com/us/news-list/BYD-Announces-all-its-Pure-EVs-Will-now-Come-With-Blade-Batteries.html", type: "直接資料", collectionState: "正式URL確認済み", publishedDate: "2021-04-07", coveragePeriod: "2021", authenticity: "高", interpretiveReliability: "中", evidenceWeight: { sourceProximity: "primary", temporalFit: "direct", independence: "single_source", decisionMakerAccess: "clear", weight: "high", rationale: "BYD自身の2021年公式発表であり、Blade Battery をEV戦略中核に置く当時資料として直接使えるため。" } },
  { id: "BYD-E-003", title: "BYD Launches e-Platform 3.0", source: "BYD official news, Sep. 8, 2021", sourceUrl: "https://www.byd.com/us/news-list/BYD-Launches-e-Platform-3-0.html", type: "直接資料", collectionState: "正式URL確認済み", publishedDate: "2021-09-08", coveragePeriod: "2021", authenticity: "高", interpretiveReliability: "中", evidenceWeight: { sourceProximity: "primary", temporalFit: "direct", independence: "single_source", decisionMakerAccess: "clear", weight: "high", rationale: "BYD自身のEV専用プラットフォーム説明であり、当時の技術・商品戦略を示すため。" } },
  ...
  { id: "BYD-E-005", title: "BYD Discontinues Production of Fuel Vehicles", source: "BYD official news, Apr. 3, 2022", sourceUrl: "https://www.byd.com/us/news-list/BYD-Discontinues-Production-of-Fuel-Vehicles.html", type: "直接資料", collectionState: "正式URL確認済み", publishedDate: "2022-04-03", coveragePeriod: "2022", authenticity: "高", interpretiveReliability: "中", evidenceWeight: { sourceProximity: "primary", temporalFit: "near_post_hoc", independence: "single_source", decisionMakerAccess: "clear", weight: "medium", rationale: "2022年の公式発表であり、EV/NEV集中の実行を示すが、2021年判断の直接証拠ではなく近接する事後資料として扱うため。" } },
  { id: "BYD-E-006", title: "BYD 2023 Annual Report", source: "BYD Company Limited / HKEX disclosure, 2024", sourceUrl: "https://www1.hkexnews.hk/listedco/listconews/sehk/2024/0326/2024032600712.pdf", type: "直接資料", collectionState: "正式URL確認済み", publishedDate: "2024-03-26", coveragePeriod: "2023", authenticity: "高", interpretiveReliability: "中", evidenceWeight: { sourceProximity: "primary", temporalFit: "post_hoc", independence: "issuer_disclosure", decisionMakerAccess: "clear", weight: "medium", rationale: "後年の公式開示であり、海外展開・競争環境の事後対照には使えるが、2021年判断の直接根拠にはしないため。" } },
];
...
const evidenceLinks = [
  ...
  { ...linkBase, id: "BYD-EL-006", evidenceId: "BYD-E-005", claimId: "byd_claim_market_policy_concentration_risk", assessmentCellId: "byd_cell_policy_regulatory_dependence", claimLabel: "EV/NEV集中の不可逆性と政策依存", target: "2022年の燃油車生産終了", relationship: "反証", timeFit: "事後", availableAtDecisionTime: false, availableToAnalysts: true, knownByDecisionMakers: "不明", knownByDecisionMakersBasis: "2022年発表のため、2021年時点の内部認識を直接示さない。", canSay: "後年の燃油車生産終了は、EV/NEV集中が実行されたことを示す。", cannotSay: "実行されたことだけで、中国政策・需要・価格競争リスクが十分に評価されていたとは言えない。" },
